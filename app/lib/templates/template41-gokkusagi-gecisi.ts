export const gokkusagiGecisiTemplate = `
<!DOCTYPE html>
<html lang="tr">
<head>
    <meta charset="UTF-8">
        ...
        * {
        ...
        .main-container::after {
            ...
            background-image: 
                ...
                radial-gradient(circle at 85% 75%, rgba(255, 255, 255, 0.3) 1.5px, transparent 1.5px),
        ...
        .profile-container::before {
            ...
            border-radius: 50%;
            background: linear-gradient(45deg, #FF6B6B, #4ECDC4, #45B7D1, #96CEB4, #FFEAA7, #DDA0DD) border-box;
        ...
        <div class="card-content">
            <div class="profile-container">
                ...
                <div class="profile-placeholder">
                    <i class="fas fa-rainbow" style="font-size: 45px; color: #FFFFFF;"></i>
                </div>
                {{/if}}
            </div>
        ...
        <div class="custom-popup-content" style="max-width: 500px;">
            ...
            <div class="bank-accounts-list">
                {{#if iban.value}}
                        ...
                        <div class="bank-card">
                            <div style="display: flex; align-items: center; margin-bottom: 15px;">
                                ...
                                <div>
                                    ...
                                    <div style="color: rgba(255, 255, 255, 0.9); font-size: 0.9rem;">{{bank.account_holder}}</div>
                                </div>
                            </div>
                            {{#each bank.accounts}}
                                <div style="display: flex; align-items: center; margin-bottom: 10px;">
                                    <span style="display: inline-flex; width: 32px; height: 32px; border-radius: 50%; background: linear-gradient(45deg, #FF6B6B, #4ECDC4); color: #FFFFFF; font-weight: bold; align-items: center; justify-content: center; margin-right: 10px; font-size: 0.85rem;">
                                        {{#if this.currency}}
                    ...
                    {{/each}}
                {{else}}
                    <div style="text-align:center; color:rgba(255, 255, 255, 0.8); padding: 40px;">Tanımlı banka hesabı bulunamadı.</div>
                {{/if}}
            </div>
        </div>
    </div>
