export const gridfolioTemplate = `
<!DOCTYPE html>
<html lang="tr">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        * {
        ...
        /* 9. Icon Colors - Consistent accent */
        .icon-card:nth-child(1) i { color: #00ACC1; } /* QR */
        .icon-card i.fa-phone { color: #00ACC1; }
        .icon-card i.fa-envelope { color: #00ACC1; }
        .icon-card i.fa-whatsapp { color: #00ACC1; }
        .icon-card i.fab.fa-telegram { color: #00ACC1; }
        .icon-card i.fab.fa-instagram { color: #00ACC1; }
        .icon-card i.fab.fa-facebook { color: #00ACC1; }
        .icon-card i.fab.fa-twitter { color: #00ACC1; }
        .icon-card i.fab.fa-linkedin { color: #00ACC1; }
        .icon-card i.fab.fa-youtube { color: #00ACC1; }
        .icon-card i.fab.fa-tiktok { color: #00ACC1; }
        .icon-card i.fa-globe { color: #00ACC1; }
        .icon-card i.fa-map-marker-alt { color: #00ACC1; }
        .icon-card i.fa-university { color: #00ACC1; }
        .icon-card i.fa-file-invoice { color: #00ACC1; }
        .icon-card i.fa-info-circle { color: #00ACC1; }
        .icon-card i.fa-book { color: #00ACC1; }
        ...
        .custom-popup-content {
            ...
            max-width: 400px;
            width: 90%;
            box-shadow: 0 20px 60px rgba(38, 50, 56, 0.3);
            position: relative;
        ...
        <div class="card-content">
            ...
            <div class="profile-container">
                ...
                <div class="profile-placeholder">
                    <i class="fas fa-user" style="font-size: 48px; color: #CFD8DC;"></i>
                </div>
                {{/if}}
            </div>
        ...
        <div class="custom-popup-content" style="max-width: 500px;">
            ...
            <div class="bank-accounts-list">
                {{#if iban.value}}
                    {{#each (parseBankAccounts iban.value) as |bank|}}
                        <div class="bank-card">
                            <div style="display: flex; align-items: center; margin-bottom: 15px;">
                                ...
                                {{/if}}
                                <div>
                                    <div style="font-weight: 600; font-size: 0.9rem; color: #00ACC1;">{{bank.bank_label}}</div>
                                    <div style="color: #546E7A; font-size: 0.8rem;">{{bank.account_holder}}</div>
                                </div>
                            </div>
                            {{#each bank.accounts}}
                                <div style="display: flex; align-items: center; margin-bottom: 8px;">
                                    <span style="display: inline-flex; width: 28px; height: 28px; border-radius: 0; background: #00ACC1; color: #FFFFFF; font-weight: 600; align-items: center; justify-content: center; margin-right: 8px; font-size: 0.75rem;">
                                        {{#if this.currency}}
                    ...
                    {{/each}}
                {{else}}
                    <div style="text-align:center; color:#546E7A; padding: 32px;">Tanımlı banka hesabı bulunamadı.</div>
                {{/if}}
            </div>
        </div>
    </div>
