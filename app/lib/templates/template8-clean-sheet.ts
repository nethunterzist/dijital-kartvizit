export const cleanSheetTemplate = `
<!DOCTYPE html>
<html lang="tr">
<head>
    <meta charset="UTF-8">
        ...
        <div class="card-content">
            ...
            <div class="profile-container">
                ...
                <div class="profile-placeholder">
                    <i class="fas fa-user" style="font-size: 56px; color: #CCC;"></i>
                </div>
                {{/if}}
            </div>
        ...
        <div class="custom-popup-content" style="max-width: 500px;">
            ...
            <div class="bank-accounts-list">
                {{#if iban.value}}
                    ...
                    {{/each}}
                {{else}}
                    <div style="text-align:center; color:#888; padding: 40px; font-weight: 300;">Tanımlı banka hesabı bulunamadı.</div>
                {{/if}}
            </div>
        </div>
    </div>
