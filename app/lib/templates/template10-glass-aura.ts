export const glassAuraTemplate = `
<!DOCTYPE html>
<html lang="tr">
<head>
    <meta charset="UTF-8">
        ...
        * {
        ...
        body::before {
            ...
            background: 
                ...
                radial-gradient(circle at 40% 40%, rgba(0, 184, 217, 0.2) 0%, transparent 50%);
            z-index: -1;
            pointer-events: none;
        }
        ...
        .person-name {
            ...
            margin-bottom: 6px;
            color: #00B8D9;
            text-shadow: 0 2px 8px rgba(0, 184, 217, 0.3);
        }
        .position {
            font-size: 1rem;
        ...
        /* 10. Icon Colors - Soft glass colors */
        .icon-card:nth-child(1) i { color: #4CAF50; } /* QR */
        .icon-card i.fa-phone { color: #2196F3; }
        .icon-card i.fa-envelope { color: #FF9800; }
        .icon-card i.fa-whatsapp { color: #4CAF50; }
        .icon-card i.fab.fa-telegram { color: #00BCD4; }
        .icon-card i.fab.fa-instagram { color: #E91E63; }
        .icon-card i.fab.fa-facebook { color: #3F51B5; }
        .icon-card i.fab.fa-twitter { color: #03DAC6; }
        .icon-card i.fab.fa-linkedin { color: #2196F3; }
        .icon-card i.fab.fa-youtube { color: #F44336; }
        .icon-card i.fab.fa-tiktok { color: #FFFFFF; }
        .icon-card i.fa-globe { color: #9C27B0; }
        .icon-card i.fa-map-marker-alt { color: #FF5722; }
        .icon-card i.fa-university { color: #4CAF50; }
        .icon-card i.fa-file-invoice { color: #00BCD4; }
        .icon-card i.fa-info-circle { color: #00B8D9; }
        .icon-card i.fa-book { color: #FFC107; }
        ...
        <div class="card-content">
            ...
            <div class="profile-container">
                ...
                <div class="profile-placeholder">
                    <i class="fas fa-user" style="font-size: 52px; color: rgba(255, 255, 255, 0.6);"></i>
                </div>
                {{/if}}
            </div>
                    ...
                    {{#each (parseBankAccounts iban.value) as |bank|}}
                        <div class="bank-card">
                            <div style="display: flex; align-items: center; margin-bottom: 15px;">
                                ...
                                {{/if}}
                                <div>
                                    <div style="font-weight: 600; font-size: 0.9rem; color: #00B8D9;">{{bank.bank_label}}</div>
                                    <div style="color: rgba(255, 255, 255, 0.8); font-size: 0.8rem;">{{bank.account_holder}}</div>
                                </div>
                            </div>
                            {{#each bank.accounts}}
                                <div style="display: flex; align-items: center; margin-bottom: 8px;">
                                    <span style="display: inline-flex; width: 28px; height: 28px; border-radius: 50%; background: rgba(0, 184, 217, 0.8); color: #FFFFFF; font-weight: 600; align-items: center; justify-content: center; margin-right: 8px; font-size: 0.75rem; backdrop-filter: blur(10px);">
                                        {{#if this.currency}}
    ...
    function copyToClipboard(text, event) {
        ...
        navigator.clipboard.writeText(text).then(function() {
            ...
            setTimeout(() => { 
                ...
                btn.style.background = 'rgba(0, 184, 217, 0.3)';
