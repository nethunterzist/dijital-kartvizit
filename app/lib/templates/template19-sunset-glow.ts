        ...
        <div class="card-content">
            <div class="profile-container">
                ...
                <div class="profile-placeholder">
                    <i class="fas fa-user" style="font-size: 52px; color: rgba(255, 255, 255, 0.8);"></i>
                </div>
                {{/if}}
            </div>
        ...
        <div class="custom-popup-content" style="max-width: 500px;">
            ...
            <div class="bank-accounts-list">
                {{#if iban.value}}
                    {{#each (parseBankAccounts iban.value) as |bank|}}
                        <div class="bank-card">
                            <div style="display: flex; align-items: center; margin-bottom: 15px;">
                                ...
                                {{/if}}
                                <div>
                                    <div style="font-weight: 600; font-size: 0.9rem; color: #FF6B35;">{{bank.bank_label}}</div>
                                    <div style="color: #D2691E; font-size: 0.8rem;">{{bank.account_holder}}</div>
                                </div>
                            </div>
                            {{#each bank.accounts}}
                                <div style="display: flex; align-items: center; margin-bottom: 8px;">
                                    <span style="display: inline-flex; width: 28px; height: 28px; border-radius: 50%; background: linear-gradient(135deg, #FF6B35, #F7931E); color: #FFFFFF; font-weight: 600; align-items: center; justify-content: center; margin-right: 8px; font-size: 0.75rem;">
                                        {{#if this.currency}}
                    ...
                    {{/each}}
                {{else}}
                    <div style="text-align:center; color:#D2691E; padding: 32px;">Tanımlı banka hesabı bulunamadı.</div>
                {{/if}}
            </div>
        </div>
    </div>
