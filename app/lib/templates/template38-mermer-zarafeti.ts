export const mermerZarafetiTemplate = `
<!DOCTYPE html>
<html lang="tr">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        * {
        ...
        .main-container::after {
            ...
            bottom: 0;
            background: 
                radial-gradient(ellipse at 20% 30%, rgba(160, 160, 160, 0.1) 0%, transparent 50%),
                radial-gradient(ellipse at 80% 70%, rgba(140, 140, 140, 0.08) 0%, transparent 50%);
            z-index: 1;
        }
        ...
        <div class="card-content">
            <div class="profile-container">
                ...
                <div class="profile-placeholder">
                    <i class="fas fa-gem" style="font-size: 45px; color: #D4AF37;"></i>
                </div>
                {{/if}}
            </div>
        ...
        <div class="custom-popup-content" style="max-width: 500px;">
            ...
            <div class="bank-accounts-list">
                {{#if iban.value}}
                    {{#each (parseBankAccounts iban.value) as |bank|}}
                        <div class="bank-card">
                            <div style="display: flex; align-items: center; margin-bottom: 16px;">
                                ...
                                {{/if}}
                                <div>
                                    <div style="font-weight: 600; font-size: 1.1rem; color: #2C2C2C;">{{bank.bank_label}}</div>
                                    <div style="color: #666666; font-size: 0.9rem;">{{bank.account_holder}}</div>
                                </div>
                            </div>
                            {{#each bank.accounts}}
                                <div style="display: flex; align-items: center; margin-bottom: 12px;">
                                    <span style="display: inline-flex; width: 35px; height: 35px; border-radius: 50%; background: linear-gradient(135deg, #D4AF37, #B8941F); color: #FFFFFF; font-weight: 600; align-items: center; justify-content: center; margin-right: 12px; font-size: 0.9rem;">
                                        {{#if this.currency}}
                    ...
                    {{/each}}
                {{else}}
                    <div style="text-align:center; color:#666666; padding: 40px;">Tanımlı banka hesabı bulunamadı.</div>
                {{/if}}
            </div>
        </div>
    </div>
